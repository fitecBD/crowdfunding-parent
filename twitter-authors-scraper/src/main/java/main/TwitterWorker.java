...
public class TwitterWorker implements Runnable {
	...
	private void doRun(org.bson.Document authorDocument) {
		...
		List<org.bson.Document> twitterDataList = new ArrayList<>();
		...
		org.bson.Document updated = new org.bson.Document("scraping", twitterDataList);
